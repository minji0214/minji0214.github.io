...
---
# 한줄 평..아니 여러줄 평..
<mark>구글은 어떻게 디자인 하는가</mark> 라는 책은 구글에서 하고 있는 포용적 디자인 (inclusive design)에 대해 소개하는 책이다. 인간 다양성 전반을 제품설계 과정에 고려하는 사고방식에 대하여 왜 우리가 이걸 해야하는지,  어떻게 팀을 설득해서 이걸 진행할지를 포괄적으로 담고 있다. 교과서적인 책이라는 평이 많았다.  

<mark>포용적 디자인(inclusive design)</mark>은 성별, 나이, 신체 능력, 문화, 언어 등 인간의 다양성을 처음부터 의식적으로 고려해, 가능한 한 많은 사람이 자연스럽게 사용할 수 있도록 제품을 설계하는 접근 방식이다. 장애인을 위한 배리어 프리나 웹접근성보다 더 넓은 개념으로, '누구를 위해 만드는가'라는 질문을 설계 단계부터 던지며 의도적으로 다양한 사용자를 포함시키려는 태도라고 할 수 있다.

책의 초반부 에서는 포용적 디자인은 자원이 부족하고 속도가 중요한 스타트업에서는 현실적으로 불가능하다고 생각되어 뜬구름 잡는 소리처럼 느껴졌다. frontend 개발자로서 최소한의 포용성인 웹 접근성 조차 챙기지 못할때도 있었기 때문이다. '포용적'이라는 단어를 가리고 시야를 넓혀 우리가 배제하고 있는 유저는 없을까? 하고 생각을 전환했을때, 새로운 발견을 할 수 있었다.
